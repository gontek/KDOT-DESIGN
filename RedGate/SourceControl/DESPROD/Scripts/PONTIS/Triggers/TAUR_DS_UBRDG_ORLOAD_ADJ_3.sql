CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_ORLOAD_ADJ_3
   after insert or update of ORLOAD_ADJ_3 on pontis.USERBRDG for each row
...
begin
  ...
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.ORLOAD_ADJ_3, -9),
                                 Nvl(:New.ORLOAD_ADJ_3, -9),
