CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_POSTED_SIGN_TYPE
   after insert or update of POSTED_SIGN_TYPE on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.POSTED_SIGN_TYPE, '<MISSING>' ) <>  nvl( old.POSTED_SIGN_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
