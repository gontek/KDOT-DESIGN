CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_AENDRATING
   after insert or update of AENDRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.AENDRATING, '<MISSING>' ) <>  nvl( old.AENDRATING, '<MISSING>' ) ) declare
   lb_result boolean;
