CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_TRANS_LANES
   after insert or update of TRANS_LANES on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.TRANS_LANES, -9 ) <>  nvl( old.TRANS_LANES, -9 ) ) declare
   lb_result boolean;
