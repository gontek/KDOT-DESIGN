CREATE OR REPLACE TRIGGER pontis.taur_ds_BRIDGE_PARALSTRUC
   after insert or update of PARALSTRUC on pontis.BRIDGE for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 DISABLE WHEN ( nvl( new.PARALSTRUC, '<MISSING>' ) <>  nvl( old.PARALSTRUC, '<MISSING>' ) ) declare
   lb_result boolean;
