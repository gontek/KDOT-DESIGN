CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_BRINSPFREQ_KDOT
   after insert or update of BRINSPFREQ_KDOT on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.BRINSPFREQ_KDOT, -9 ) <>  nvl( old.BRINSPFREQ_KDOT, -9 ) ) declare
   lb_result boolean;
