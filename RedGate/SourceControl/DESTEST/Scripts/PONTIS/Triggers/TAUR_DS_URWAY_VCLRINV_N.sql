CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_VCLRINV_N
   after insert or update of VCLRINV_N on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.VCLRINV_N, -9 ) <>  nvl( old.VCLRINV_N, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.VCLRINV_N, -9),
                                 NVL(:New.VCLRINV_N, -9),
