CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_DK_DRAIN_SYS
   after insert or update of DK_DRAIN_SYS on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DK_DRAIN_SYS, '<MISSING>' ) <>  nvl( old.DK_DRAIN_SYS, '<MISSING>' ) ) declare
   lb_result boolean;
