CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_UWINSPFREQ_KDOT
   after insert or update of UWINSPFREQ_KDOT on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN ( nvl( new.UWINSPFREQ_KDOT, -9 ) <>  nvl( old.UWINSPFREQ_KDOT, -9 ) ) declare
   lb_result boolean;
