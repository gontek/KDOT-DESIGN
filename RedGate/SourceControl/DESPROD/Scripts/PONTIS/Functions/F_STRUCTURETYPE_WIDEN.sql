CREATE OR REPLACE function pontis.f_structuretype_widen(v_brkey pontis.userstrunit.brkey%type,v_strunitkey pontis.userstrunit.strunitkey%type)
return varchar2 is
  retval varchar2(4);
begin
