...
REFRESH START WITH TO_DATE('2016-5-19 7:16:0', 'yyyy-mm-dd hh24:mi:ss') NEXT SYSDATE + (DECODE(TO_CHAR(SYSDATE,'D'),6,3,7,2,1)) 
AS select B.BRKEY,
       BR.WORK_TYPE,
       BR.PROJ_NUM,
...
from BROMS.BROMS_QUERY BR, pontis.BRIDGE B
