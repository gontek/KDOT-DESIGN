CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_MAINT_AREA
   after insert or update of MAINT_AREA on pontis.USERBRDG for each row
...
--    2003.01.03  - Deb, KDOT -- Line 38 was inadvertently commented out...fixed.
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.MAINT_AREA, '<MISSING>' ) <>  nvl( old.MAINT_AREA, '<MISSING>' ) ) declare
   lb_result boolean;
