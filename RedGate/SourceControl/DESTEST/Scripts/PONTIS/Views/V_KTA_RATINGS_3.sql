CREATE OR REPLACE FORCE VIEW pontis.v_kta_ratings_3 ("IDENTIFIER",brkey,brg_name,bridgeno,prefix,routeno,func,ftcr,route,insp_date,deck,super,sub,channel,culv,strc,dgeo,uncl,watr,algn,fclastdate,uwlastdate,northsouth) AS
