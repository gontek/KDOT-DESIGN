CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_ORLOAD_WSD_3S2
   after insert or update of ORLOAD_WSD_3S2 on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.ORLOAD_WSD_3S2, -9),
                                 Nvl(:New.ORLOAD_WSD_3S2, -9),
