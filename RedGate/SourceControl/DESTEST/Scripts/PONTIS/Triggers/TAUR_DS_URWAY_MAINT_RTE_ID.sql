CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_MAINT_RTE_ID
   after insert or update of MAINT_RTE_ID on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.MAINT_RTE_ID, '<MISSING>' ) <>  nvl( old.MAINT_RTE_ID, '<MISSING>' ) ) declare
   lb_result boolean;
