CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_DKMEMBTYPE
   after insert or update of DKMEMBTYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DKMEMBTYPE, '<MISSING>' ) <>  nvl( old.DKMEMBTYPE, '<MISSING>' ) ) declare
   lb_result boolean;
