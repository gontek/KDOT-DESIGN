...
kta_id
   ...
   WHERE userbrdg.brkey = bridge.brkey and
      ...
      userstrunit.strunitkey = (select min(strunitkey) from structure_unit u
          where u.brkey = userstrunit.brkey and
              u.strunittype = (select min(strunittype) from structure_unit t
