CREATE OR REPLACE TRIGGER pontis.taur_ds_BRIDGE_STRFLARED
   after insert or update of STRFLARED on pontis.BRIDGE for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 DISABLE WHEN ( nvl( new.STRFLARED, '<MISSING>' ) <>  nvl( old.STRFLARED, '<MISSING>' ) ) declare
   lb_result boolean;
