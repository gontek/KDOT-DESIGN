CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_UNIT_MATERIAL
   after insert or update of UNIT_MATERIAL on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.UNIT_MATERIAL, '<MISSING>' ) <>  nvl( old.UNIT_MATERIAL, '<MISSING>' ) ) declare
   lb_result boolean;
