CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_ARAILRATIN
   after insert or update of ARAILRATIN on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.ARAILRATIN, '<MISSING>' ) <>  nvl( old.ARAILRATIN, '<MISSING>' ) ) declare
   lb_result boolean;
