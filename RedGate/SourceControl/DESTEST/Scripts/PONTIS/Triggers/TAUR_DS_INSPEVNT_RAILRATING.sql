CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_RAILRATING
   after insert or update of RAILRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.RAILRATING, '<MISSING>' ) <>  nvl( old.RAILRATING, '<MISSING>' ) ) declare
   lb_result boolean;
