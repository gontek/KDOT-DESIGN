CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_DECK_MATRL
   after insert or update of DECK_MATRL on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DECK_MATRL, '<MISSING>' ) <>  nvl( old.DECK_MATRL, '<MISSING>' ) ) declare
   lb_result boolean;
