CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_SUPER_PAINT_SYS
   after insert or update of SUPER_PAINT_SYS on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.SUPER_PAINT_SYS, '<MISSING>' ) <>  nvl( old.SUPER_PAINT_SYS, '<MISSING>' ) ) declare
   lb_result boolean;
