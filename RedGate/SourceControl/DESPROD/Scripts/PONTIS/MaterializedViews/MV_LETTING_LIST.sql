CREATE MATERIALIZED VIEW pontis.mv_letting_list (proj_id,strucname,dist,area,old_ser,new_ser,bif_new_ser,work_type,let_act_date)
REFRESH START WITH TO_DATE('2016-5-18 13:37:56', 'yyyy-mm-dd hh24:mi:ss') NEXT SYSDATE + (DECODE(TO_CHAR(SYSDATE,'D'),6,3,7,2,1)) 
