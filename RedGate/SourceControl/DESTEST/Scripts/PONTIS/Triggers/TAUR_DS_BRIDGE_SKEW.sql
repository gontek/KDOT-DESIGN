CREATE OR REPLACE TRIGGER pontis.taur_ds_BRIDGE_SKEW
   after insert or update of SKEW on pontis.BRIDGE for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 DISABLE WHEN (nvl( new.SKEW, -9 ) <>  nvl( old.SKEW, -9 ) and new.skew > 0 ) declare
   lb_result boolean;
