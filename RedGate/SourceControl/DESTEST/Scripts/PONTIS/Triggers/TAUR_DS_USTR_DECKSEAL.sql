CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_DECKSEAL
   after insert or update of DECKSEAL on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DECKSEAL, '<MISSING>' ) <>  nvl( old.DECKSEAL, '<MISSING>' ) ) declare
   lb_result boolean;
