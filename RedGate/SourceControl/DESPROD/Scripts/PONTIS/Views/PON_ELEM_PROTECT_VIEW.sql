CREATE OR REPLACE FORCE VIEW pontis.pon_elem_protect_view (brkey,inspkey,elem_parent_key,elem_key,envkey,strunitkey,elem_quantity,elem_scale_factor,elem_pctstate1,elem_pctstate2,elem_pctstate3,elem_pctstate4,elem_desc,elem_createdatetime,elem_createuserkey,elem_modtime,elem_moduserkey,elem_docrefkey,elem_notes) AS
select PON_ELEM_INSP.BRKEY,
             ...
             where exists (select null
                             from PON_ELEM_DEFS
                            where PON_ELEM_DEFS.ELEM_KEY = PON_ELEM_INSP.ELEM_KEY
                     and PON_ELEM_DEFS.ELEM_NBE_STAT = 'N'
                              and ELEM_PROTECT_SYS = 'Y'
                              and ELEM_SMART_FLAG = 'N');