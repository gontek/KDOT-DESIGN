CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_MEDIAN_WIDTH
   after insert or update of MEDIAN_WIDTH on pontis.USERBRDG for each row
...
begin
  ...
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.MEDIAN_WIDTH, -9),
                                 Nvl(:New.MEDIAN_WIDTH, -9),
