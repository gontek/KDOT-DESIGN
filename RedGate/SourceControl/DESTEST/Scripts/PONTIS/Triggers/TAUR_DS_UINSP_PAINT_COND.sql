CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_PAINT_COND
   after insert or update of PAINT_COND on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.PAINT_COND, '<MISSING>' ) <>  nvl( old.PAINT_COND, '<MISSING>' ) ) declare
   lb_result boolean;
