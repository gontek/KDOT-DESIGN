CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_SUPER_DESIGN_TY
   after insert or update of SUPER_DESIGN_TY on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.SUPER_DESIGN_TY, '<MISSING>' ) <>  nvl( old.SUPER_DESIGN_TY, '<MISSING>' ) ) declare
   lb_result boolean;
