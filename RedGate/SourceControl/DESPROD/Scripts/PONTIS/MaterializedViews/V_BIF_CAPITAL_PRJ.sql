...
REFRESH COMPLETE START WITH TO_DATE('2016-5-18 11:6:20', 'yyyy-mm-dd hh24:mi:ss') NEXT SYSDATE + 6/24 
AS select substr(a.str_name,2,3)||substr(a.str_name,8,3) brkey,
 ...
 from can_v_str_brid@canp.world a,can_v_str_actv@canp.world b
    where 1=1
