CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_WATERADEQ
   after insert or update of WATERADEQ on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.WATERADEQ, '<MISSING>' ) <>  nvl( old.WATERADEQ, '<MISSING>' ) ) declare
   lb_result boolean;
