CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_UWLASTINSP
   after insert or update of UWLASTINSP on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.UWLASTINSP, TO_DATE( '1901-01-01', 'YYYY-MM-DD' ) ) <>  nvl( old.UWLASTINSP, TO_DATE( '1901-01-01', 'YYYY-MM-DD' ) ) ) declare
   lb_result boolean;
