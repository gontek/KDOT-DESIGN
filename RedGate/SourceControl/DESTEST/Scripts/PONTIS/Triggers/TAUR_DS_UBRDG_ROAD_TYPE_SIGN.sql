CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_ROAD_TYPE_SIGN
   after insert or update of ROAD_TYPE_SIGN on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ROAD_TYPE_SIGN, '<MISSING>' ) <>  nvl( old.ROAD_TYPE_SIGN, '<MISSING>' ) ) declare
   lb_result boolean;
