CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_STRRATING
   after insert or update of STRRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.STRRATING, '<MISSING>' ) <>  nvl( old.STRRATING, '<MISSING>' ) ) declare
   lb_result boolean;
