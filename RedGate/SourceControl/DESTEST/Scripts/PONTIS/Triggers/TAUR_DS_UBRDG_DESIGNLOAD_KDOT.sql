CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_DESIGNLOAD_KDOT
   after insert or update of DESIGNLOAD_KDOT on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.DESIGNLOAD_KDOT, -9),
                                 Nvl(:New.DESIGNLOAD_KDOT, -9),
