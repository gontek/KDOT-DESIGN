CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_SUBRATING
   after insert or update of SUBRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.SUBRATING, '<MISSING>' ) <>  nvl( old.SUBRATING, '<MISSING>' ) ) declare
   lb_result boolean;
