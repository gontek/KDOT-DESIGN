CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_SKEW_DIRECTION
   after insert or update of SKEW_DIRECTION on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.SKEW_DIRECTION, '<MISSING>' ) <>  nvl( old.SKEW_DIRECTION, '<MISSING>' ) ) declare
   lb_result boolean;
