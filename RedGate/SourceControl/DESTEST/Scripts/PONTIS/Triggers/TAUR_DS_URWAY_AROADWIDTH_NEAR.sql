CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_AROADWIDTH_NEAR
   after insert or update of AROADWIDTH_NEAR on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.AROADWIDTH_NEAR, -9 ) <>  nvl( old.AROADWIDTH_NEAR, -9 )and new.on_under = '1' ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.AROADWIDTH_NEAR, -9),
                                 NVL(:New.AROADWIDTH_NEAR,-9),
