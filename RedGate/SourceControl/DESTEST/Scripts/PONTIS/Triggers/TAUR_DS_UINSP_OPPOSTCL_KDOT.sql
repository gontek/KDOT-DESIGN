CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_OPPOSTCL_KDOT
   after insert or update of OPPOSTCL_KDOT on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 DISABLE WHEN (  (OLD.OPPOSTCL_KDOT <> NEW.OPPOSTCL_KDOT) AND
  (NEW.OPPOSTCL_KDOT <> '1') ) declare
   lb_result boolean;
