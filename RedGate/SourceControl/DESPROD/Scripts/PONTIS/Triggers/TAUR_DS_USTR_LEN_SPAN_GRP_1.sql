CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_LEN_SPAN_GRP_1
   after insert or update of LEN_SPAN_GRP_1 on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.LEN_SPAN_GRP_1, -9 ) <>  nvl( old.LEN_SPAN_GRP_1, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.LEN_SPAN_GRP_1, -9),
                                 Nvl(:New.LEN_SPAN_GRP_1, -9),
