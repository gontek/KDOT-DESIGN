CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_ROT_ANGLE_DEG
   after insert or update of ROT_ANGLE_DEG on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ROT_ANGLE_DEG, -9 ) <>  nvl( old.ROT_ANGLE_DEG, -9 ) ) declare
   lb_result boolean;
