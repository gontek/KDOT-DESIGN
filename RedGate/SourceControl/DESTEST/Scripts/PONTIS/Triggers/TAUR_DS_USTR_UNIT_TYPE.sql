CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_UNIT_TYPE
   after insert or update of UNIT_TYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.UNIT_TYPE, '<MISSING>' ) <>  nvl( old.UNIT_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
