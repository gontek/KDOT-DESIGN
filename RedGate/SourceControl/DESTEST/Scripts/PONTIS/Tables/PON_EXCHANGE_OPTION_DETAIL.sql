CREATE TABLE pontis.pon_exchange_option_detail (
  ...
  CONSTRAINT fk_detail_to_exchange_option FOREIGN KEY (exchange_option_id) REFERENCES pontis.pon_exchange_option (exchange_option_id) ON DELETE CASCADE DISABLE NOVALIDATE
);