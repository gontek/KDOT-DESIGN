CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_ROUTE_UNIQUE_ID
   after insert or update of ROUTE_UNIQUE_ID on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.ROUTE_UNIQUE_ID, '<MISSING>' ) <>  nvl( old.ROUTE_UNIQUE_ID, '<MISSING>' ) ) declare
   lb_result boolean;
