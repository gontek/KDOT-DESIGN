CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_ORIENTATION
   after insert or update of ORIENTATION on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ORIENTATION, '<MISSING>' ) <>  nvl( old.ORIENTATION, '<MISSING>' ) ) declare
   lb_result boolean;
