CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_NUM_GIRDERS
   after insert or update of NUM_GIRDERS on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.NUM_GIRDERS, -9 ) <>  nvl( old.NUM_GIRDERS, -9 ) ) declare
   lb_result boolean;
