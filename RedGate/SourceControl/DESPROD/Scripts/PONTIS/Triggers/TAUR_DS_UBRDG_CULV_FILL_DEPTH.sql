CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_CULV_FILL_DEPTH
   after insert or update of CULV_FILL_DEPTH on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.CULV_FILL_DEPTH, -9),
                                 Nvl(:New.CULV_FILL_DEPTH, -9),
