CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_ABUT_TYPE_FAR
   after insert or update of ABUT_TYPE_FAR on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.ABUT_TYPE_FAR, '<MISSING>' ) <>  nvl( old.ABUT_TYPE_FAR, '<MISSING>' ) ) declare
   lb_result boolean;
