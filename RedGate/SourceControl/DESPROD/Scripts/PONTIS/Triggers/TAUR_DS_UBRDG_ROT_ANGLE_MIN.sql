CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_ROT_ANGLE_MIN
   after insert or update of ROT_ANGLE_MIN on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ROT_ANGLE_MIN, -9 ) <>  nvl( old.ROT_ANGLE_MIN, -9 ) ) declare
   lb_result boolean;
