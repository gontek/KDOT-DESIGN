CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_ROT_DIRECTION
   after insert or update of ROT_DIRECTION on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ROT_DIRECTION, '<MISSING>' ) <>  nvl( old.ROT_DIRECTION, '<MISSING>' ) ) declare
   lb_result boolean;
