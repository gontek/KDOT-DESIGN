CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_ROUTE_SUFFIX
   after insert or update of ROUTE_SUFFIX on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.ROUTE_SUFFIX, '<MISSING>' ) <>  nvl( old.ROUTE_SUFFIX, '<MISSING>' ) ) declare
   lb_result boolean;
