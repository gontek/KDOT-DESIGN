CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_DESIGNLOAD_TYPE
   after insert or update of DESIGNLOAD_TYPE on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.DESIGNLOAD_TYPE, '<MISSING>' ) <>  nvl( old.DESIGNLOAD_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
