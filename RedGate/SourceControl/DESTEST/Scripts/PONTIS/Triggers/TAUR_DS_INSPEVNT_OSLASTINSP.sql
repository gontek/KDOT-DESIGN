CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_OSLASTINSP
   after insert or update of OSLASTINSP on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.OSLASTINSP, TO_DATE( '1901-01-01', 'YYYY-MM-DD' ) ) <>  nvl( old.OSLASTINSP, TO_DATE( '1901-01-01', 'YYYY-MM-DD' ) ) ) declare
   lb_result boolean;
