CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_RAIL_TYPE
   after insert or update of RAIL_TYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.RAIL_TYPE, '<MISSING>' ) <>  nvl( old.RAIL_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
