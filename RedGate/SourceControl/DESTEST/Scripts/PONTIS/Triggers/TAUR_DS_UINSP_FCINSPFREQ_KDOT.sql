CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_FCINSPFREQ_KDOT
   after insert or update of FCINSPFREQ_KDOT on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.FCINSPFREQ_KDOT, -9 ) <>  nvl( old.FCINSPFREQ_KDOT, -9 ) ) declare
   lb_result boolean;
