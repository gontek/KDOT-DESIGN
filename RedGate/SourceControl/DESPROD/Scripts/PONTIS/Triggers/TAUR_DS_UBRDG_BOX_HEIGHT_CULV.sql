CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_BOX_HEIGHT_CULV
   after insert or update of BOX_HEIGHT_CULV on pontis.USERBRDG for each row
...
begin
   ...
   -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.BOX_HEIGHT_CULV, -9),
                                 :New.BOX_HEIGHT_CULV,
