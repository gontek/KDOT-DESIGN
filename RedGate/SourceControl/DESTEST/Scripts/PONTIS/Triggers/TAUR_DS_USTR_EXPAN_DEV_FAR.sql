CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_EXPAN_DEV_FAR
   after insert or update of EXPAN_DEV_FAR on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.EXPAN_DEV_FAR, '<MISSING>' ) <>  nvl( old.EXPAN_DEV_FAR, '<MISSING>' ) ) declare
   lb_result boolean;
