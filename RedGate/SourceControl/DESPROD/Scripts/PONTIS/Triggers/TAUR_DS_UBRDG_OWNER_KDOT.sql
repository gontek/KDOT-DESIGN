CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_OWNER_KDOT
   after insert or update of OWNER_KDOT on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.OWNER_KDOT, '<MISSING>' ) <>  nvl( old.OWNER_KDOT, '<MISSING>' ) ) declare
   lb_result boolean;
