CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_BRIDGEMED_KDOT
   after insert or update of BRIDGEMED_KDOT on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.BRIDGEMED_KDOT, '<MISSING>' ) <>  nvl( old.BRIDGEMED_KDOT, '<MISSING>' ) ) declare
   lb_result boolean;
