...
--,bif.f_get_bif_spanlist(b.brkey) as strunits
...
,case
  when nvl(bif.f_get_bif_inspecdata(b.brkey,'userinsp','spcl_last_insp'),'01/01/1901') > '01/01/1902'
    then bif.f_get_bif_inspecdate(b.brkey,'userinsp','spcl_last_insp')
      else ''
        end  as spcllastinsp
...
,case
  when nvl(bif.f_get_bif_inspecdate(b.brkey,'userinsp','spcl_next_insp'),'01/01/1901') > '01/01/1902'
    then to_char(extract(year from to_date(bif.f_get_bif_inspecdate(b.brkey,'userinsp','spcl_next_insp'),'mm/dd/yyyy')))
     else ''
        end as spclnextinsp

,case
when bif.f_get_bif_inspecdate(b.brkey,'inspevnt','fclastinsp')> '01/01/1902' then
  bif.f_get_bif_inspecdate(b.brkey,'inspevnt','fclastinsp')
  else ''
    end as fclastinsp
...
,case
 when bif.f_get_bif_inspecdate(b.brkey,'inspevnt','fcnextdate')> '01/01/1901' then
  to_char(extract(year from to_date(bif.f_get_bif_inspecdate(b.brkey,'inspevnt','fcnextdate'),'mm/dd/yyyy')))
   else ''
     end as fcnextdate
...
when nvl(bif.f_get_bif_inspecdata(b.brkey,'userinsp','fcinspfreq_kdot'),0) > 0
 ...
 ,case
when bif.f_get_bif_inspecdata(b.brkey,'inspevnt','oslastinsp') <> '01-JAN-01' then
 to_date(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','oslastinsp'),'dd/mm/yy')
  else to_date(null)
    end as oslastinsp
,decode(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','osinspreq'),'Y','Yes','N','') as osinspreq
,case
 when bif.f_get_bif_inspecdata(b.brkey,'inspevnt','osnextdate')<> '01-JAN-01' then
   to_char(extract(year from to_date(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','osnextdate'),'dd-mm-yy')))
   else ''
     end as osnextdate
,case
when nvl(bif.f_get_bif_inspecdata(b.brkey,'userinsp','osinspfreq_kdot'),'0') > 0
 ...
 ,case
when bif.f_get_bif_inspecdata(b.brkey,'inspevnt','uwlastinsp') <> '01-JAN-01' then
 to_date(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','uwlastinsp'),'dd/mm/yy')
  else to_date(null)
    end as uwlastinsp
,decode(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','uwinspreq'),'Y','Yes','N','') as uwinspreq
,case
 when bif.f_get_bif_inspecdata(b.brkey,'inspevnt','uwnextdate')<> '01-JAN-01' then
   to_char(extract(year from to_date(bif.f_get_bif_inspecdata(b.brkey,'inspevnt','uwnextdate'),'dd/mm/yy')))
   else ''
     end as uwnextdate
,case
when nvl(bif.f_get_bif_inspecdata(b.brkey,'userinsp','uwinspfreq_kdot'),'0') > 0
 ...
 ---
  ,case
  when nvl(bif.f_get_bif_inspecdata(b.brkey,'userinsp','snoop_last_insp'),'01/01/1901') > '01/01/1901'
    then bif.f_get_bif_inspecdate(b.brkey,'userinsp','snoop_last_insp')
      else ''
...
,case
  when nvl(bif.f_get_bif_inspecdate(b.brkey,'userinsp','snoop_next_insp'),'01/01/1901') > '01/01/1902'
    then to_char(extract(year from to_date(bif.f_get_bif_inspecdate(b.brkey,'userinsp','snoop_next_insp'),'mm/dd/yyyy')))
     else ''
...
where u.brkey = b.brkey
     and  b.district <> '9'
     and ((substr(b.brkey,4,1) <> '5' and f_get_bif_inspecdata(b.brkey,'userinsp','brinspfreq_kdot') in ('0','1','2')) or
...
where u.brkey = b.brkey
     and  b.district <> '9'
     and ((substr(b.brkey,4,1) <> '5' and f_get_bif_inspecdata(b.brkey,'userinsp','brinspfreq_kdot') = '1') or
