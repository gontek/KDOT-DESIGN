CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_CHAN_PROT_RIGHT
   after insert or update of CHAN_PROT_RIGHT on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.CHAN_PROT_RIGHT, '<MISSING>' ) <>  nvl( old.CHAN_PROT_RIGHT, '<MISSING>' )and new.on_under >'1' ) declare
   lb_result boolean;
