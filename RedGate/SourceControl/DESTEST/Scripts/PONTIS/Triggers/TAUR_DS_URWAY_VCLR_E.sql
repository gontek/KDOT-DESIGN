CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_VCLR_E
   after insert or update of VCLR_E on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.VCLR_E, -9 ) <>  nvl( old.VCLR_E, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.VCLR_E, -9),
                                 Nvl(:New.VCLR_E, -9),
