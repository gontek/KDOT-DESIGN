CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_PIER_FOOT_TYPE
   after insert or update of PIER_FOOT_TYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.PIER_FOOT_TYPE, '<MISSING>' ) <>  nvl( old.PIER_FOOT_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
