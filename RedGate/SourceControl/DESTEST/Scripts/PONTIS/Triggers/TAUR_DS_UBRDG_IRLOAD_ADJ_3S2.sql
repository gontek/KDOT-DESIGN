CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_IRLOAD_ADJ_3S2
   after insert or update of IRLOAD_ADJ_3S2 on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.IRLOAD_ADJ_3S2, -9),
                                 Nvl(:New.IRLOAD_ADJ_3S2, -9),
