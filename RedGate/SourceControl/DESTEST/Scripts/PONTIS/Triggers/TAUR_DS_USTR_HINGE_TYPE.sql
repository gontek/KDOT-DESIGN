CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_HINGE_TYPE
   after insert or update of HINGE_TYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.HINGE_TYPE, '<MISSING>' ) <>  nvl( old.HINGE_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
