CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_APPRALIGN
   after insert or update of APPRALIGN on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.APPRALIGN, '<MISSING>' ) <>  nvl( old.APPRALIGN, '<MISSING>' ) ) declare
   lb_result boolean;
