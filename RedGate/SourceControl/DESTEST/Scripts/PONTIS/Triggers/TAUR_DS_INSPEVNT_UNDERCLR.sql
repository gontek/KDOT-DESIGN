CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_UNDERCLR
   after insert or update of UNDERCLR on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.UNDERCLR, '<MISSING>' ) <>  nvl( old.UNDERCLR, '<MISSING>' ) ) declare
   lb_result boolean;
