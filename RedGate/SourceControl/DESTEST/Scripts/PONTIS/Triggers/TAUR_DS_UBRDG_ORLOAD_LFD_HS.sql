CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_ORLOAD_LFD_HS
   after insert or update of ORLOAD_LFD_HS on pontis.USERBRDG for each row
...
begin
  ...
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.ORLOAD_LFD_HS, -9),
                                 Nvl(:New.ORLOAD_LFD_HS, -9),
