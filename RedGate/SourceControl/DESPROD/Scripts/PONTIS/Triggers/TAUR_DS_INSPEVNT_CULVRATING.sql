CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_CULVRATING
   after insert or update of CULVRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.CULVRATING, '<MISSING>' ) <>  nvl( old.CULVRATING, '<MISSING>' ) ) declare
   lb_result boolean;
