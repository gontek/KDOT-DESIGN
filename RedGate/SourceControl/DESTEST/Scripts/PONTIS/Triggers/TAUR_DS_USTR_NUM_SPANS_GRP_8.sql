CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_NUM_SPANS_GRP_8
   after insert or update of NUM_SPANS_GRP_8 on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.NUM_SPANS_GRP_8, -9 ) <>  nvl( old.NUM_SPANS_GRP_8, -9 ) ) declare
   lb_result boolean;
