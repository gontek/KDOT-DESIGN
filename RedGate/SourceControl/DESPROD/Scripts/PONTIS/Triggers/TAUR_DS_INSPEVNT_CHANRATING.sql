CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_CHANRATING
   after insert or update of CHANRATING on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.CHANRATING, '<MISSING>' ) <>  nvl( old.CHANRATING, '<MISSING>' ) ) declare
   lb_result boolean;
