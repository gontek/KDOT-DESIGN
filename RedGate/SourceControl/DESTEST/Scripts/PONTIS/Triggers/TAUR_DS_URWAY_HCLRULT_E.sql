CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_HCLRULT_E
   after insert or update of HCLRULT_E on pontis.USERRWAY for each row
...
--    2002.07.08  - Allen Marshall, CS -- Added direction indicator for transfer keys...
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.HCLRULT_E, -9 ) <>  nvl( old.HCLRULT_E, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.HCLRULT_E, -9),
                                 Nvl(:New.HCLRULT_E, -9),
