CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_CHAN_PROT_LEFT
   after insert or update of CHAN_PROT_LEFT on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.CHAN_PROT_LEFT, '<MISSING>' ) <>  nvl( old.CHAN_PROT_LEFT, '<MISSING>' ) and new.on_under >'1') declare
   lb_result boolean;
