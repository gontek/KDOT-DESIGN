CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_ROUTE_NUM
   after insert or update of ROUTE_NUM on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.ROUTE_NUM, '<MISSING>' ) <>  nvl( old.ROUTE_NUM, '<MISSING>' ) ) declare
   lb_result boolean;
