CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_IRLOAD_WSD_T130
   after insert or update of IRLOAD_WSD_T130 on pontis.USERBRDG for each row
...
begin
  ...
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.IRLOAD_WSD_T130, -9),
                                 Nvl(:New.IRLOAD_WSD_T130, -9),
