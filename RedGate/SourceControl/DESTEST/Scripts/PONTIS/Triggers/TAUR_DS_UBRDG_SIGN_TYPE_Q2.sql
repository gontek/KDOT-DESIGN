CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_SIGN_TYPE_Q2
   after insert or update of SIGN_TYPE_Q2 on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.SIGN_TYPE_Q2, '<MISSING>' ) <>  nvl( old.SIGN_TYPE_Q2, '<MISSING>' ) ) declare
   lb_result boolean;
