CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_HCLRULT_W
   after insert or update of HCLRULT_W on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.HCLRULT_W, -9 ) <>  nvl( old.HCLRULT_W, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.HCLRULT_W, -9),
                                 Nvl(:New.HCLRULT_W, -9),
