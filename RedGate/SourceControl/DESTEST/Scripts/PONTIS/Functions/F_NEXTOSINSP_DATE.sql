CREATE OR REPLACE function pontis.f_nextOSinsp_date(v_brkey bridge.brkey%type)

return date is
  retval date;

v_freq userinsp.osinspfreq_kdot%type;
v_date inspevnt.oslastinsp%type;
v_inspkey inspevnt.inspkey%type;

begin
 
select oslastinsp,nvl(osinspfreq_kdot,0),i.inspkey
