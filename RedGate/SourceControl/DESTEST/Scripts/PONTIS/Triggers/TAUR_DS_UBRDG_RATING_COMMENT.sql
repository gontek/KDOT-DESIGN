CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_RATING_COMMENT
   after insert or update of RATING_COMMENT on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.RATING_COMMENT, '<MISSING>' ) <>  nvl( old.RATING_COMMENT, '<MISSING>' ) ) declare
   lb_result boolean;
