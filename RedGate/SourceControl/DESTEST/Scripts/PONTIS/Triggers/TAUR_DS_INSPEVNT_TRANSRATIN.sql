CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_TRANSRATIN
   after insert or update of TRANSRATIN on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.TRANSRATIN, '<MISSING>' ) <>  nvl( old.TRANSRATIN, '<MISSING>' ) ) declare
   lb_result boolean;
