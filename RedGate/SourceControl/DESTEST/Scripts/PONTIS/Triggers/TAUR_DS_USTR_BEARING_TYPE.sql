CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_BEARING_TYPE
   after insert or update of BEARING_TYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.BEARING_TYPE, '<MISSING>' ) <>  nvl( old.BEARING_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
