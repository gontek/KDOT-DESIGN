CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_HCLRURT_N
   after insert or update of HCLRURT_N on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.HCLRURT_N, -9 ) <>  nvl( old.HCLRURT_N, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.HCLRURT_N, -9),
                                 Nvl(:New.HCLRURT_N, -9),
