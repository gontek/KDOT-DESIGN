CREATE OR REPLACE TRIGGER pontis.taur_ds_UINSP_UWATER_INSP_TYP
   after insert or update of UWATER_INSP_TYP on pontis.USERINSP for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  WHEN (nvl( new.UWATER_INSP_TYP, '<MISSING>' ) <>  nvl( old.UWATER_INSP_TYP, '<MISSING>' ) ) declare
   lb_result boolean;
