CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_CULV_WING_TYPE
   after insert or update of CULV_WING_TYPE on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.CULV_WING_TYPE, '<MISSING>' ) <>  nvl( old.CULV_WING_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
