CREATE OR REPLACE TRIGGER pontis.taur_ds_ROADWAY_ROADWIDTH
   after insert or update of ROADWIDTH on pontis.ROADWAY for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.ROADWIDTH, -9 ) <>  nvl( old.ROADWIDTH, -9 )
