CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_DESIGN_REF_POST
   after insert or update of DESIGN_REF_POST on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.DESIGN_REF_POST, -9 ) <>  nvl( old.DESIGN_REF_POST, -9 ) ) declare
   lb_result boolean;
