CREATE OR REPLACE TRIGGER pontis.taur_ds_INSPEVNT_DECKGEOM
   after insert or update of DECKGEOM on pontis.INSPEVNT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DECKGEOM, '<MISSING>' ) <>  nvl( old.DECKGEOM, '<MISSING>' ) ) declare
   lb_result boolean;
