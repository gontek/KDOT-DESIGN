CREATE OR REPLACE TRIGGER pontis.taur_ds_BRIDGE_DECKWIDTH
   after insert or update of DECKWIDTH on pontis.BRIDGE for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 DISABLE WHEN (nvl( new.DECKWIDTH, -9 ) <>  nvl( old.DECKWIDTH, -9 )
and nvl(new.deckwidth, -9) > 0 ) declare
   lb_result boolean;
