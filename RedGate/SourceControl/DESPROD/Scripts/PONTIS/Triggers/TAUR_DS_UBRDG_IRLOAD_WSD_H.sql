CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_IRLOAD_WSD_H
   after insert or update of IRLOAD_WSD_H on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.IRLOAD_WSD_H, -9),
                                 Nvl(:New.IRLOAD_WSD_H, -9),
