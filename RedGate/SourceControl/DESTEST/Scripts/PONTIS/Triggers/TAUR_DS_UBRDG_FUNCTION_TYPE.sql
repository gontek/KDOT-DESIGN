CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_FUNCTION_TYPE
   after insert or update of FUNCTION_TYPE on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.FUNCTION_TYPE, '<MISSING>' ) <>  nvl( old.FUNCTION_TYPE, '<MISSING>' ) ) declare
   lb_result boolean;
