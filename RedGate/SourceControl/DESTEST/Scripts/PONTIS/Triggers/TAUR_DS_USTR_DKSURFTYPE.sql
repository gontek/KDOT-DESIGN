CREATE OR REPLACE TRIGGER pontis.taur_ds_USTR_DKSURFTYPE
   after insert or update of DKSURFTYPE on pontis.USERSTRUNIT for each row
...
-- Generated 2002-02-26 at 09:26
  ...
  DISABLE WHEN (nvl( new.DKSURFTYPE, '<MISSING>' ) <>  nvl( old.DKSURFTYPE, '<MISSING>' ) ) declare
   lb_result boolean;
