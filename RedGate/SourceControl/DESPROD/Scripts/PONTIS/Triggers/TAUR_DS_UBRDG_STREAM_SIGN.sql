CREATE OR REPLACE TRIGGER pontis.taur_ds_UBRDG_STREAM_SIGN
   after insert or update of STREAM_SIGN on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.STREAM_SIGN, '<MISSING>' ) <>  nvl( old.STREAM_SIGN, '<MISSING>' ) ) declare
   lb_result boolean;
