CREATE OR REPLACE TRIGGER pontis.taur_ds_URWAY_HCLRURT_E
   after insert or update of HCLRURT_E on pontis.USERRWAY for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.HCLRURT_E, -9 ) <>  nvl( old.HCLRURT_E, -9 ) ) declare
  lb_result    boolean;
  ls_bridge_id bridge.bridge_id%type;
begin

  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.HCLRURT_E, -9),
                                 Nvl(:New.HCLRURT_E, -9),
