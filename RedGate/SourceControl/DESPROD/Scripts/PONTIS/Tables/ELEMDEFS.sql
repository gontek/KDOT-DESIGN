CREATE TABLE pontis.elemdefs (
  ...
  CONSTRAINT fk_elemdefs_30_eltypdfs FOREIGN KEY (ecatkey,etypkey) REFERENCES pontis.eltypdfs (ecatkey,etypkey) ON DELETE CASCADE,
  CONSTRAINT fk_elemdefs_49_matdefs FOREIGN KEY (matlkey) REFERENCES pontis.matdefs (matlkey) ON DELETE CASCADE,
  CONSTRAINT fk_elemdefs_50_metric_e FOREIGN KEY (paircode) REFERENCES pontis.metric_english (paircode)
);
