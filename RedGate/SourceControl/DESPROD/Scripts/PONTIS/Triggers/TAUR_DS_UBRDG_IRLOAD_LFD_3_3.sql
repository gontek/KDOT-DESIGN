CREATE OR REPLACE Trigger pontis.taur_ds_UBRDG_IRLOAD_LFD_3_3
   after insert or update of IRLOAD_LFD_3_3 on pontis.USERBRDG for each row
...
begin
  -- new code
  IF Ksbms_Util.f_Numbers_Differ(Nvl(:Old.IRLOAD_LFD_3_3, -9),
                                 Nvl(:New.IRLOAD_LFD_3_3, -9),
