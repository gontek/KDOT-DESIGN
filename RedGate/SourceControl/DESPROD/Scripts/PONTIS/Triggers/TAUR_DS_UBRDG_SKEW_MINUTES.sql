CREATE OR REPLACE TRIGGER pontis.TAUR_DS_UBRDG_SKEW_MINUTES
   after insert or update of SKEW_MINUTES on pontis.USERBRDG for each row
...
-- Generated 2002-02-26 at 09:26
 ...
 WHEN (nvl( new.SKEW_MINUTES, -9 ) <>  nvl( old.SKEW_MINUTES, -9 ) ) declare
   lb_result boolean;
